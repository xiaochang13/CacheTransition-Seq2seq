...
days = set(['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'])
...
quantities = {'one':1, 'two':2, 'three':3, 'four':4, 'five':5, 'six':6, 'seven':7, 'eight':8, 'nine':9, 'ten':10, 'billion':1000000000, 'tenth':10, 'million':1000000, 'thousand':1000, 'hundred':100, 'viii':8, 'eleven':11, 'twelve':12, 'thirteen':13, 'iv':4, 'august':8, 'dozen':12, 'twenty':20, 'twice':2, 'trillion':1000000000000, 'a':1, 'fourty':40, 'forty':40, 'thirty':30, 'fifty':50}
def isNumber(s):
    regex = re.compile('([^0-9\s]*)[0-9]+[\.,0-9]*([^0-9\s]*)')
    match = regex.match(s)
    return match and len(match.group(1)) == 0 and len(match.group(2)) == 0
